                ...
                <form method="POST" action="processing.php">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="sex">
                            ...
                            <option <?php if($ad['sex']==2) echo 'selected'; ?> value="2">Nữ</option>
                            <option <?php if($ad['sex']==3) echo 'selected'; ?> value="3">Khác</option>
                        </select>
                    </div>
                    <div class="mb-3">
                     ...
                     <?php
                     if($ad['level']==100)
                     echo '<a class="btn btn-outline-primary" href="addadmin.php">Thêm tài khoản mới</a>';
                     ?>
                    </div>
                </form>
            </div>
